...
/// remark:
/// Left-aligned Label and Right-Aligned content TextField
/// <ul>
///   <li>
...
@interface TextCell (SWIFT_EXTENSION(CommonCell))
/// <ul>
///   <li>
///     Description: Configure contentTextField constraints
///   </li>
/// </ul>
- (void)configContentTextFieldConstraints:(UITextField * _Nonnull)tf;
@end
...
@interface TextCell (SWIFT_EXTENSION(CommonCell))
/// Create Title Label
- (UILabel * _Nonnull)createDescriptionLabel SWIFT_WARN_UNUSED_RESULT;
/// Create Content TextField
- (UITextField * _Nonnull)createContentTextField SWIFT_WARN_UNUSED_RESULT;
@end
